...
export const themeStore = defineStore({
  ...
  getters: {
    getDrawer: (state) => state.isDrawer,
    getWartermark: (state) => state.isWartermark,
    getWartermarkText:(state) => state.wartermarkText,
  ...
  actions: {
    ...
    setWartmarker(data:boolean){
        this.isWartermark = data
    },
    setWartermarkText(text:string){
        this.wartermarkText = text
    },
